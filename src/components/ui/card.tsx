...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-base xl:text-lg 2xl:text-xl leading-snug font-medium group-data-[size=sm]/card:text-sm", className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-muted-foreground text-sm xl:text-base 2xl:text-lg", className)}
      {...props}
    />
  )
}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 xl:text-base 2xl:text-lg group-data-[size=sm]/card:px-3", className)}
      {...props}
    />
  )
}
